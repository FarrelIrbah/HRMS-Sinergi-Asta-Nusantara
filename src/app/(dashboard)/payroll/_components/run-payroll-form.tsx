...
import { runPayrollAction } from "@/lib/actions/payroll.actions";

// ─── Schema ───────────────────────────────────────────────────────────────────

// shadcn Select returns string values; coerce to number for schema compatibility
...
export function RunPayrollForm() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      toast.success("Penggajian berhasil dihitung");
